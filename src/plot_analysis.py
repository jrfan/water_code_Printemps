...
def get_h_data(
    ...
    if by_type:
        ...
        for t in types:
            ...
            sel = data[
                simulation.actors_type == t, :, :
            ]  # shape: (actors_of_type, runs, turns)
...
def plot_data(
    ...
    # Apply styling
    apply_common_style(ax, title=title, xlabel="Turn (Week)", ylabel=label)
...
def compare_data(
    ...
    # Apply styling
    apply_common_style(ax, title=title, xlabel=xlabel, ylabel=ylabel)
